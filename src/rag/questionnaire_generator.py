...
class QuestionnaireGenerator:
    ...
    def generate_questionnaire_for_content(
        ...
        """
        Generate a questionnaire (2 questions and answers) for a single content item.
    ...
    def _generate_qa_with_llm(
        ...
        try:
            ...
            prompt = f"""
            Based on the following {content_type_description}, generate exactly 2 specific question-answer pairs 
            ...
            return self._generate_default_qa(text_content, source_file, page_id)
    ...
    def _generate_default_qa(
        self, text_content: str, source_file: str, page_id: str
    ) -> List[Dict[str, Any]]:
        """
        Generate default question-answer pairs when LLM fails.
        ...
        Returns:
            List of default question-answer pairs
        """
        logger.warning(f"Generating default QA pairs for {source_file}, page {page_id}")

        return [
            {
                "question": "What are the main educational concepts discussed in this subject area?",
                "answer": "This content covers fundamental educational concepts related to the subject matter.",
                "source_file": source_file,
                "page_id": page_id,
            },
            {
                "question": "What key principles or facts should students understand about this topic?",
                "answer": "Students should understand the core principles and facts relevant to this educational topic.",
                "source_file": source_file,
                "page_id": page_id,
            },
        ]
    ...
    def generate_and_print_questionnaires(
        ...
        for content_item in content_items:
            qa_pairs = self.generate_questionnaire_for_content(content_item)
